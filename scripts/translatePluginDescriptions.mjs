...
async function translateBatch(strings, targetLang) {
    ...
    try {
        ...
        console.warn(`  ⚠️ Split mismatch (got ${parts.length}, expected ${strings.length}) for ${targetLang}, retrying one-by-one...`);
...
async function main() {
    ...
    const lines = [
        ...
        ` */`,
        ``,
        `// Auto-generated by scripts/translatePluginDescriptions.mjs.`,
        ``,
