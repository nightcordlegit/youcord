                ...
                <ModalContent style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "16px", alignItems: "center" } as any}>
                    {isYouCord ? (
                        ...
                        plugin.authors?.map(a => {
                            ...
                            const avatarUrl = user ? user.getAvatarURL(undefined, 128) : "data:image/png;base64,";
                            return (
